          ...
          <div className="contact-side">
            <div className="contact-flx">
              ...
              <div className="contaxt-text">
                <p>Phone</p>
                <p className="text-xl">
                  <a href="tel:+4733378901">+92 3061359665</a>
                </p>
              </div>
            </div>
            <div className="contact-flx">
              ...
              <div className="contaxt-text">
                <p>Email</p>
                <p className="text-xl">
                  <a className="text-white" href="mailto:ansarsultan2002@gmail.com">
                    ansarsultan2002@gmail.com
                  </a>
                </p>
              </div>
            </div>
            <div className="contact-flx">
              ...
              <div className="contaxt-text">
                <p>Address</p>
                <p className="text-xl">
                  Street 6, Sector H, Gujjar Choke, Manzoor Colony, Karachi
                </p>
              </div>
            </div>
          </div>
